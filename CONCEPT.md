...
- **More escape-time formulas** — Burning Ship and Multibrot (power 2–8) as variants of one shader iteration core. Deep zoom (perturbation) remains Mandelbrot-only — the z² algebra doesn't carry over — with a UI warning past f32 precision. Bookmark family tags: `burning_ship`, `multibrot`.
